        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form id="upload-form" action="{{ route('dashboard.career.update', $career->id) }}" method="post" enctype="multipart/form-data">
    ...
    document.getElementById('upload-button').addEventListener('click', function (e) {
        ...
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                window.location.href = "{{ route('dashboard.career.index') }}"; // Redirect on success
            } else {
