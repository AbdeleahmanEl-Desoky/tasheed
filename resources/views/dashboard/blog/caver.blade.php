    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">@lang('site.blog_caver')</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form id="upload-form" action="{{ route('dashboard.blog.store_caver') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control ckeditor" id="ex1"
                                      name="description" rows="3">{{$blog?->description}}</textarea>
                        ...
                        <div class="form-group form-group col-md-4">
                            ...
                            <select name="file_type" class="form-control" id="file_type">
                                <option value="image" {{ $blog?->file_type == 'image' ? 'selected' : '' }}>Image</option>
                                <option value="video" {{ $blog?->file_type == 'video' ? 'selected' : '' }}>Video</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            @if($blog?->file_type == 'video')
                                <video class="form-group col-md-6" controls style="width: 100px;">
                                    <source src="{{ $blog?->media[0]->original_url }}" type="" class="img-thumbnail image-preview">
                                </video>
                            @else
                                <img src="{{  $blog?->media[0]->original_url  }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                            @endif
                        </div>
                        <div class="form-group col-md-12">
