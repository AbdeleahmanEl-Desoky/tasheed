    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.about.galleries.index') }}"> @lang('site.galleries')</a></li>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form id="upload-form" action="{{ route('dashboard.about.galleries.update', $gallery->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            <img src="{{  $gallery->media[0]->original_url  }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div>
    ...
    document.getElementById('upload-button').addEventListener('click', function (e) {
        ...
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                window.location.href = "{{ route('dashboard.about.galleries.index') }}"; // Redirect on success
            } else {
